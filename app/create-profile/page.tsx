            ...
            <Card className="border-slate-200 shadow-md">
              <CardContent className="space-y-6 p-6 sm:p-8">
                ...
                <form className="space-y-6" onSubmit={handleUpload}>
                  ...
                  <div className="space-y-2">
                    ...
                    {!file ? (
                      ...
                      >
                        ...
                        <p className="mt-5 text-md font-semibold text-foreground">
                  ...
                  <Button type="submit" disabled={isLoading || !file} className="h-12 w-full rounded-full text-md">
                    {isLoading ? (
                      <>
            ...
            <Card className="border-slate-200 shadow-md">
              <CardContent className="space-y-5 p-6 sm:p-8">
                ...
                <form className="space-y-5" onSubmit={handleManual}>
                  ...
                  <Button type="submit" disabled={isLoading} className="h-12 w-full rounded-full text-md">
                    {isLoading ? (
                      <>
                        <Loader2 className="h-4 w-4 animate-spin" aria-hidden />
                        Saving…
