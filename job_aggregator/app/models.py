...
class Job(Base):
    ...
    kind: Mapped[str] = mapped_column(String(24), nullable=False, default="listing")
    classification: Mapped[str] = mapped_column(String(32), nullable=False, default="employer_hiring")
