...
export default function MobileNav() {
  ...
  return (
    <nav
      className="wg-dash-mobilenav fixed bottom-0 left-0 right-0 z-50 border-t border-[var(--dash-border)] bg-white/90 backdrop-blur-xl md:hidden"
            ...
            <li key={routeId}>
              <button
                ...
                className={cn(
                  ...
                  active ? "text-[var(--dash-accent)]" : "text-[var(--dash-text-secondary)]",
                )}
